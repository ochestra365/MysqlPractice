...
-- 테이블 데이터 classicmodels.customers:~122 rows (대략적) 내보내기
...
-- 테이블 classicmodels.employees 구조 내보내기
...
-- 테이블 데이터 classicmodels.employees:~23 rows (대략적) 내보내기
...
-- 테이블 classicmodels.offices 구조 내보내기
...
-- 테이블 데이터 classicmodels.offices:~7 rows (대략적) 내보내기
DELETE FROM `offices`;
...
-- 테이블 classicmodels.orderdetails 구조 내보내기
...
-- 테이블 데이터 classicmodels.orderdetails:~1,302 rows (대략적) 내보내기
...
-- 테이블 classicmodels.orders 구조 내보내기
...
-- 테이블 데이터 classicmodels.orders:~326 rows (대략적) 내보내기
DELETE FROM `orders`;
...
-- 테이블 classicmodels.payments 구조 내보내기
...
-- 테이블 데이터 classicmodels.payments:~273 rows (대략적) 내보내기
...
-- 테이블 classicmodels.productlines 구조 내보내기
...
-- 테이블 데이터 classicmodels.productlines:~0 rows (대략적) 내보내기
...
-- 테이블 classicmodels.products 구조 내보내기
...
-- 테이블 데이터 classicmodels.products:~110 rows (대략적) 내보내기
